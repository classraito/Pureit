...
#import "UILabel+LineSpace.h"//TODO:rui.ogng changed at 2016/03/04
...
-(void)addSubviewsWithOverlay:(BOOL)withOverlay
{
    ...
    if (_title) {
        ...
        yPos = CGRectGetMaxY(_titleLabel.frame) + insideVerticalMargin + 20;
    }
    ...
    [_messageLabel setLineSpace:7 alignment:NSTextAlignmentCenter];//TODO:rui.ogng changed at 2016/03/04
    [_messageLabel sizeToFit];//TODO:rui.ogng changed at 2016/03/04
    _messageLabel.center = CGPointMake(_alertView.frame.size.width / 2, _messageLabel.center.y);//TODO:rui.ogng changed at 2016/03/04
    
    yPos = CGRectGetMaxY(_messageLabel.frame) + insideVerticalMargin + 20;
