...
-(void)doGetUserInfo:(NSMutableDictionary *)_dic_receivedData
{
    ...
    {
        NSString *str_url = [NSString stringWithFormat:URL_GETUSERINFO_WEIXIN,str_accessToken,str_openid];
...
-(void)didReceiveUserInfo:(NSMutableDictionary *)_dic_receivedData
{
    ...
    if(jsonData)
    {
        ...
        NSMutableDictionary *_dic_userinfo_wechat = [str_userinfo_json objectFromJSONString];
        NSString *_str_username = [_dic_userinfo_wechat objectForKey:@"nickname"];
        int gender = [[_dic_userinfo_wechat objectForKey:@"sex"] intValue];
        ...
        [commond saveToKeyChain:KEYCHAIN_KEY_USERINFO passwd:_str_json];
